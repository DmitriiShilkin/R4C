# Task 1
Создан API-endpoint ```/api/robots/```, принимающий и обрабатывающий информацию в формате JSON. 
...
Дополнительно предусмотрена валидация входных данных, на соответствие существующим в системе моделям, версиям и
серийным номерам.
